...
package cn.sczhckj.order.websocket;
...
public class WebSocketConnection implements WebSocket {
    ...
    private List<ContentValues> mWsHeaders;
    ...
    public void connect(String wsUri, String[] wsSubprotocols, WebSocket.ConnectionHandler wsHandler, WebSocketOptions options, List<ContentValues> headers) throws WebSocketException {
