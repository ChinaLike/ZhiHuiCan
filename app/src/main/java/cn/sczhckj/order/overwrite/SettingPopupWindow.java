...
public class SettingPopupWindow extends PopupWindow {
    ...
    private void settingDefault() {
        ip.setText("" + MyApplication.share.getData("ip", Config.DEFAULT_IP));
        port.setText("" + MyApplication.share.getData("port", Config.DEFAULT_PORT));
    }
    ...
    public void onClick() {
        ...
        Config.setUrlNotificationService();
